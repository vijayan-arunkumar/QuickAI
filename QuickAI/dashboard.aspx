...
<body>
    <form id="form1" runat="server">
        <div style="position: fixed; z-index: 1; width: 100%; height: 60px">
        ...
        <div class="sidebar">
            <ul>
                ...
                <li><a href="#"><i class="fa-solid fa-file"></i>
                    <div>
                        <asp:DropDownList class="dropdown-item-text" runat="server" OnSelectedIndexChanged="Unnamed1_SelectedIndexChanged">
            ...
            <ul>
                ...
                <li><a href="check.aspx"><i class="fa-solid fa-layer-group"></i>
                    <div>Templates</div>
                </a></li>
                <li><a href="#"><i class="fa-solid fa-image"></i>
                    <div>AI Imagesa</div>
                </a></li>
                <li><a href="#"><i class="fa-solid fa-comment-dots"></i>
                    <div>AI Chats</div>
                </a></li>
