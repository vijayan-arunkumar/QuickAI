                     ...
                     <div  class="sidebar">
                         <ul>
                            ...
                            <li>
                             ...
                             <li>
                              <a href="#">
                                  <i class="fa-solid fa-file"></i> <div> <asp:DropDownList  class="dropdown-item-text" runat="server" OnSelectedIndexChanged="Unnamed1_SelectedIndexChanged">
                     ...
                     <div class="main">
                       ...
                       <div  class="row">
                         ...
                         <div class="charts">
                          ...
                          <div style="padding-top:30px;border-top:1px solid #808080;margin-left:10px;margin-right:10px;" class="row">
                              <div style="border-right: 1px solid #808080; padding:0 50px;" class="col-md-8">
                                   <div class="copyfoot">    
                                     <p style="color:grey">2023 Socius IGB Pvt Ltd, All right reserved</p>
                                   </div>
                               </div>                                                                        
                               <div class="col-md-4">
                                   <div class="icons">
